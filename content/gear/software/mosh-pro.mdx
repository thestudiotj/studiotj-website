...
status: "current"
tag: "Effects App"
hook: "Real-time visual effects mixer for when a photo or video needs to look like something went wrong on purpose."
hero_image: "/gear/software/mosh-pro-hero.webp"
